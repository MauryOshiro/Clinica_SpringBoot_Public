			...
			<section class="content">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Novo profissional</h3>
					</div>
					<div class="box-body">
						<form role="form" action="novoProfissional" method="post">
							<div class="row">
							<!-- Essa tela de cadastro está dividida em 2 colunas de tamanho 6 do Bootsdtrap -->
								...
								<div class="col-sm-6">
									...
									<div class="row">
										<div class="col-sm-6">
											<label>CRP</label>
											<input class="form-control" type="text" placeholder="CRP do profissional" name="crp">
										</div>
										<div class="col-sm-6">
											<div class="form-group">
